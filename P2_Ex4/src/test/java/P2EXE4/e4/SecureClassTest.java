...
public class SecureClassTest {
	...
	public void LerDoArquivo() {
	    ...
	    assertEquals("Digite a operacao desejada para realizar no arquivo <R para ler um arquivo, W para escrever em um arquivo>? teste", outContent.toString());
	    
	}
	
	@Test
	public void ProblemaNaLeituraDoBuffer() throws IOException {
		SecureClass vc = new SecureClass();
		String FILENAME = "TesteArqProb.txt";
		String input = "";
	    ...
	    assertEquals("Digite a operacao desejada para realizar no arquivo <R para ler um arquivo, W para escrever em um arquivo>? Problema na leitura do buffer.", outContent.toString());
